...
setwd("C:/Users/Shiya/Desktop/PIAAC/0_Overview")
```

## Load the Data
Let's get started by loading the data from SPSS to R:
...
dat.all<-read.spss("C:\\Users\\Shiya\\Desktop\\PIAAC\\Full-time Professionals\\ALL_new.sav",use.value.labels = FALSE)
...
dat.all$ISCO2C[dat.all$ISCO2C<10]<-NA

dat.all$PARED[dat.all$PARED>5]<-NA
```

## 14 Countries & Six Occupational Categories
We can see that our sample contains 8,535 full-time professionals from 14 participating countries and six occupational categories.
...
### Block I: Socio-Demographic Background
...
#### Describe the Demographic Background & Job Characteris of the Sample
...
#### What about Indicators of Skill Use at Work?
